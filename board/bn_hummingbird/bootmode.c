...
static inline int load_display_vendor(void)
{
...
{
	char buffer[256];
	sprintf(buffer, "setenv bootargs ${bootargs} vmalloc=768M init=/init rootwait androidboot.hardware=hummingbird boot.fb=%x", FB);
