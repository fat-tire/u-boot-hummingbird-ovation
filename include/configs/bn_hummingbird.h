/*
 * Configuration settings for the BN Ovation Board
 *
...
#define CONFIG_HUMMINGBIRD		1    /* working with B&N Hummingbird */
#define CONFIG_FASTBOOT		1    /* Using fastboot interface */

/*
  * Product type defined by hw0~hw2
  * - 0x02      Acclaim
  * - 0x03      Ovation/Penguin
  * - 0x04      Panther
  * - 0x05      Hummingbird
  */
#define CONFIG_BOARD_PRODUCT_TYPE   0x05
...
/*
 * The threshold of battery capacity to boot into Android.
 */
#define BOOT_ANDROID		5
/*
 * If we need to do SW update, we must charge battery until its capacity is higher than BOOT_SWUPDATE.
 * Otherwise will boot into charger mode to charge.
 */
#define BOOT_SWUPDATE		8
#define VBAT_THRESH_MIN		3200

#define BQ2419X_GPIO_CE		158
#define BQ2419X_GPIO_PSEL	85
#define BQ27500_CE_GPIO		113
 ...
 */
#define V_PROMPT                 "BN Hummingbird # "
